...
![Feedback](./motivagig/src/img/print-feedback.png)
![Curso](./motivagig/src/img/print-curso.png)
...
* YouTube: (adicionar)
* Vercel: ([adicionar](https://motivagig-er3s0oloi-paulo-estalises-projects.vercel.app))
